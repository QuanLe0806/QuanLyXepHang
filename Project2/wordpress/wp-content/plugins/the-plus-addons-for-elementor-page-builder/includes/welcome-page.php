	...
	echo '<div class="theplus-panel-row">';
		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">July 01,2022 <span class="changelog-version">Pro Version 5.1.0</span></div>';
						echo '<ul class="changelog-list">';	
							echo '<li>'.esc_html__('Added : Mailchimp : GDPR Compliance checkbox','tpebl').'</li>';
							echo '<li>'.esc_html__('Added : Social Icon : Vertical Layout option','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Social Sharing : Toggle Button Shadow option','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : TP Custom Field : PODS Image support','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Stylish List : Horizontal Layout','tpebl').'</li>';
						echo '</ul>';					
				echo '</div>';
